 ...
 * @subpackage Cookiebot_Responsive/public
 */
 ...
 */
class Cookiebot_Responsive_Public {
	...
	public function enqueue_styles() {
		 ...
		 * defined in Cookiebot_Responsive_Loader as all of the hooks are defined
		 * in that particular class.
		 *
		 * The Cookiebot_Responsive_Loader will then create the relationship
		 * between the defined hooks and the functions defined in this
		 * class.
		 */

		wp_enqueue_style( $this->plugin_name, plugin_dir_url( __FILE__ ) . 'css/cookiebot-responsive-public.css', array(), $this->version, 'all' );
